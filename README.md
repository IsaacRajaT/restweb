...
<body>
    ...
    <div class="banner">
         <img src="meera.jpg" width="250" height="200">
        <h1>Meera's Kitchen</h1>
        <p>
...
<body>
    ...
    <footer>
        <p>Designed by Karthikeyan &copy; 2024</p>
    </footer>
...
<body>
    ...
    <div class="container">
        ...
        <div class="contact-info">
            <div>
                <h3>Visit Us</h3>
                <p>Meera's kitchen,shop no.07,Nehru street, Anna Nagar,chennai.</p>
            </div>
            <div>
                <h3>Call Us</h3>
                <p>9870890897</p>
